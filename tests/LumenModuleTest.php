...
class LumenModuleTest extends BaseTestCase
{
    ...
    {
        $this->assertEquals('WovoSchool/recipe', $this->module->getComposerAttr('name'));
    }
...
class LumenTestingModule extends \WovoSchool\Modules\Lumen\Module
{
}
