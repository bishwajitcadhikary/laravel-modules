...
use WovoSchool\Modules\Exceptions\InvalidAssetPath;
use WovoSchool\Modules\Exceptions\ModuleNotFoundException;
use WovoSchool\Modules\Process\Installer;
use WovoSchool\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \WovoSchool\Modules\Module
     */
     ...
     * @return string
     * @throws \WovoSchool\Modules\Exceptions\ModuleNotFoundException
     */
